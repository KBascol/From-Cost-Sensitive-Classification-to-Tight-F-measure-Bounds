"""
    Heuristic Extended Robust SVM

    Code from https://github.com/sfujiwara/er-svm
"""
...
class HeuristicERSVM:
    def __init__(self, nu=0.5, max_itr=100, heuristic_termination=True, gamma=0.01,
                 initial_weight=None, class_weight=None):
